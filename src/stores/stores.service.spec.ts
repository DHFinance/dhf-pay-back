...
describe('Store Service', () => {
    ...
    it('should change blocked status', async () => {
        ...
        const updatedStore = await storesService.changeBlockStore(newStore.id, true);
    ...
    it('should validate unblocked store', async () => {
        ...
        const updatedStore = await storesService.changeBlockStore(validStore.id, true);
        expect(updatedStore).toHaveProperty("blocked", true);
        ...
        await expect(async () => await storesService.validateStore(store.apiKey)).rejects.toThrow();
